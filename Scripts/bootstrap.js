...
!function() {
    ...
    if (n[0] < 2 && n[1] < 9 || 1 == n[0] && 9 == n[1] && n[2] < 1 || 3 < n[0])
...
function(n) {
    ...
    t.prototype.close = function(i) {
        ...
        var f = n(this), r = f.attr("data-target"), u;
        ...
        i.isDefaultPrevented() || (u.removeClass("in"),
...
function(n) {
    ...
    t.prototype.getItemForDirection = function(n, t) {
        var i = this.getItemIndex(t), r;
        return ("prev" == n && 0 === i || "next" == n && i == this.$items.length - 1) && !this.options.wrap ? t : (r = (i + ("prev" == n ? -1 : 1)) % this.$items.length,
        this.$items.eq(r))
    }
    ;
    ...
    ;
    r = function(t) {
        var u = n(this), f = u.attr("href"), s, r, o, e;
        f && (f = f.replace(/.*(?=#[^\s]+$)/, ""));
        s = u.attr("data-target") || f;
        r = n(document).find(s);
        r.hasClass("carousel") && (o = n.extend({}, r.data(), u.data()),
...
function(n) {
    ...
    t.prototype.show = function() {
        ...
        !(r && r.length && (f = r.data("bs.collapse")) && f.transitioning) && (e = n.Event("show.bs.collapse"),
...
function(n) {
    ...
    function r(t) {
        ...
        return i || (i = (i = t.attr("href")) && /#[A-Za-z]/.test(i) && i.replace(/.*(?=#[^\s]*$)/, "")),
        r = "#" !== i ? n(document).find(i) : null,
        r && r.length ? r : t.parent()
    }
    function u(t) {
        t && 3 === t.which || (n(".dropdown-backdrop").remove(),
        n(i).each(function() {
            var u = n(this)
              , i = r(u)
              , f = {
...
function(n) {
    ...
    t.prototype.setScrollbar = function() {
        var i = parseInt(this.$body.css("padding-right") || 0, 10), t;
        this.originalBodyPad = document.body.style.paddingRight || "";
        t = this.scrollbarWidth;
        this.bodyIsOverflowing && (this.$body.css("padding-right", i + t),
...
function(n) {
    ...
    function s(t, i) {
        ...
        if (-1 !== n.inArray(r, i))
            return -1 === n.inArray(r, f) || Boolean(t.nodeValue.match(e) || t.nodeValue.match(o));
    ...
    function i(t, i, r) {
        ...
        for (var a = n.map(i, function(n, t) {
            return t
        }), l = n(f.body).find("*"), o = 0, v = l.length; o < v; o++)
            if (u = l[o],
            h = u.nodeName.toLowerCase(),
            -1 !== n.inArray(h, a))
                for (var c = n.map(u.attributes, function(n) {
                    return n
                }), y = [].concat(i["*"] || [], i[h] || []), e = 0, p = c.length; e < p; e++)
                    s(c[e], y) || u.removeAttribute(c[e].nodeName);
            else
                u.parentNode.removeChild(u);
        return f.body.innerHTML
    }
    var u = ["sanitize", "whiteList", "sanitizeFn"], f = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], e = /^(?:(?:https?|mailto|ftp|tel|file):|[^&:/?#]*(?:[/?#]|$))/gi, o = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i, t = function(n, t) {
        this.type = null;
        this.options = null;
        this.enabled = null;
        this.timeout = null;
    ...
    t.prototype.getOptions = function(t) {
        ...
        for (var f in r)
            r.hasOwnProperty(f) && -1 !== n.inArray(f, u) && delete r[f];
        return (t = n.extend({}, this.getDefaults(), r, t)).delay && "number" == typeof t.delay && (t.delay = {
            show: t.delay,
            hide: t.delay
        }),
    ...
    t.prototype.setContent = function() {
        var t = this.tip()
          , n = this.getTitle();
        this.options.html ? (this.options.sanitize && (n = i(n, this.options.whiteList, this.options.sanitizeFn)),
        t.find(".tooltip-inner").html(n)) : t.find(".tooltip-inner").text(n);
    ...
    t.prototype.toggle = function(t) {
        var i = this;
        t && ((i = n(t.currentTarget).data("bs." + this.type)) || (i = new this.constructor(t.currentTarget,this.getDelegateOptions()),
        n(t.currentTarget).data("bs." + this.type, i)));
...
function(n) {
    ...
    ;
    t.prototype.setContent = function() {
        var n = this.tip(), i = this.getTitle(), t = this.getContent(), r;
        this.options.html ? (r = typeof t,
        this.options.sanitize && (i = this.sanitizeHtml(i),
        "string" === r && (t = this.sanitizeHtml(t))),
        n.find(".popover-title").html(i),
        n.find(".popover-content").children().detach().end()["string" === r ? "html" : "append"](t)) : (n.find(".popover-title").text(i),
...
function(n) {
    ...
    t.prototype.show = function() {
        ...
        !t.parent("li").hasClass("active")) {
            ...
            (r.trigger(e),
            t.trigger(o),
            o.isDefaultPrevented() || e.isDefaultPrevented()) || (u = n(document).find(i),
...
function(n) {
    ...
    t.prototype.getState = function(n, t, i, r) {
        var u = this.$target.scrollTop(), e = this.$element.offset(), o = this.$target.height(), f, s;
        return null != i && "top" == this.affixed ? u < i && "top" : "bottom" == this.affixed ? null != i ? !(u + this.unpin <= e.top) && "bottom" : !(u + o <= n - r) && "bottom" : (f = null == this.affixed,
        s = f ? u : e.top,
        null != i && u <= i ? "top" : null != r && n - r <= s + (f ? o : t) && "bottom")
    }
    ;
